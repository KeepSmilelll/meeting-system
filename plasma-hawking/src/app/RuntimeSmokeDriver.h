...
private:
    ...
    QString mediaStateSummary() const;
    ...
    void maybeScheduleChatHistorySeed();
    void sendNextChatHistorySeedMessage();
    void maybeUpdateChatHistoryPagingEvidence();
    void handleChatBubbleLayoutEvidence(bool stable, const QString& details);
    void maybeStartMediaStateValidation(const QString& reason);
    void runMediaStateToggleStep();
    void maybeUpdateMediaStateEvidence();
    ...
    bool m_requireChatHistoryPagingEvidence{false};
    bool m_requireChatBubbleLayoutEvidence{false};
    bool m_requireMediaStateSyncEvidence{false};
    ...
    bool m_chatHistoryPagingReady{false};
    bool m_chatBubbleLayoutReady{false};
    bool m_mediaStateEvidenceReady{false};
    bool m_mediaStateValidationStarted{false};
    bool m_mediaStateToggleLocal{false};
    bool m_mediaStateInitialAudioOnObserved{false};
    bool m_mediaStateAudioOffObserved{false};
    bool m_mediaStateAudioOnRestored{false};
    bool m_mediaStateInitialVideoOnObserved{false};
    bool m_mediaStateVideoOffObserved{false};
    bool m_mediaStateVideoOnRestored{false};
    bool m_mediaStateInitialVideoFrameObserved{false};
    bool m_mediaStateVideoFrameCleared{false};
    bool m_mediaStateVideoFrameRestored{false};
    bool m_mediaStatePeerUserIdExplicit{false};
    int m_mediaStateToggleStep{0};
    int m_mediaStateInitialDelayMs{3000};
    int m_mediaStateStepDelayMs{2000};
    QString m_mediaStatePeerUserId;
    bool m_chatSendScheduled{false};
    bool m_chatSent{false};
    bool m_chatHistorySeedScheduled{false};
    bool m_chatHistorySeedSent{false};
    bool m_chatHistoryOlderLoadRequested{false};
    bool m_chatHistoryInitialPageObserved{false};
    QString m_chatSendText;
    QStringList m_expectedChatTexts;
    QSet<QString> m_observedChatTexts;
    int m_chatSendDelayMs{0};
    int m_chatHistorySeedCount{55};
    int m_chatHistorySeedIntervalMs{20};
    int m_chatHistorySeedIndex{0};
    int m_chatHistoryInitialRowCount{0};
    QString m_chatHistorySeedPrefix;
    QString m_chatHistoryPagingDetail;
    QString m_chatBubbleLayoutDetail;
